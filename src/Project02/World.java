...
public class World
{
    ...
    {
        allNations.add(new Nation("Schaper", (worldLifePoints / 4)));
        allNations.add(new Nation("Nate", (worldLifePoints / 4)));
        allNations.add(new Nation("Marie", (worldLifePoints / 4)));
        allNations.add(new Nation("Jeremy", (worldLifePoints / 4)));
    }
